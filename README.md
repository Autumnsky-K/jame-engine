...
단순히 하나의 게임을 만드는 것을 넘어, **"구조의 미학(Aesthetics of Structure)"**을 추구하며 여러 아케이드 게임(스네이크, 테트리스 등)을 손쉽게 확장하고 플러그인할 수 있는 견고한 뼈대를 설계하는 데 목적을 두었습니다.
...
- **Multi-Game Architecture**: 새로운 게임을 기존 엔진 코드 수정 없이 추가할 수 있는 유연한 구조.
...
- **특징**: `PlayingState` 내부에 캡슐화되어 동작하는 첫 번째 게임 구현체.
- **기능**:
  - 충돌 감지 로직 (벽, 자기 자신)
